...
<div class="page-head">
	<h2>
	    ...
	    <a class="btn btn-success" href="<c:url value="/security/user/init"/>"><fmt:message key="security.user.init"/></a>
		</a>
	</h2>
</div>
<div class="cl-mcont">
				  ...
				  <thead>
					...
					<c:forEach items="${page.content}" var="user">
						<tr>
							...
							<td><c:forEach items="${user.roles}" var="role" varStatus="status">${role.name}<c:if test="${not status.last}">.</c:if></c:forEach></td>
